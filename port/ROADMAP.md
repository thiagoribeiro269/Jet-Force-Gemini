...
2. Estados 1 e 2: agachar, andar agachado, deslizar e rolar.
3. Estados 0xB e 5: mira com R, ainda sem tiro, com o perfil de câmera e as
   rotações de juntas da mira.
4. Depois, interação de gameplay na mesma região: tiro, projéteis, objetos e
   inimigos.
