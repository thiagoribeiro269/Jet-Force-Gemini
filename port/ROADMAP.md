...
| Estados do Juno em Forest First | Agachar, rolar, deslizar, mira sem tiro, com perfis de colisão originais | Portados: agachar, andar agachado, deslizar, rolar e mira em pé e agachada, com a pose original do modelo (`gen_anim_data`), as rotações de juntas e o Juno translúcido na mira |
...
2. Interação de gameplay na mesma região: tiro, projéteis, objetos e
   inimigos. Os estados de movimento do Juno em Forest First, as rotações
   de juntas (`0x3DB0`, `0x6290`, `0x4840`), o desbotamento da mira
   (`controlFadePlayer`) e a pose original do modelo (`gen_anim_data`, com a
   mistura de clipes do jogo) já estão portados.
