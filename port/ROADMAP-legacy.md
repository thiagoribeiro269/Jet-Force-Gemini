# Histórico — roteiro anterior à integração geral

Este documento foi substituído por [ROADMAP.md](ROADMAP.md) em 25/09/2026.
As menções a emulação/RT64 e comandos de runners são somente históricas;
não representam autorização nem a arquitetura atual.
