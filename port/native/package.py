...
files = {name: (build / name).read_bytes() for name in ("jfg_native_preview.exe", "check_animation.exe", "check_player.exe", "check_character.exe")}
...
if assets.get("character_profile"):
