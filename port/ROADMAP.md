...
| Estados do Juno em Forest First | Agachar, rolar, deslizar, mira sem tiro, com perfis de colisão originais | Portados: agachar, andar agachado, deslizar, rolar e mira em pé e agachada, com o contador de mistura de clipes, as rotações de juntas e o Juno translúcido na mira |
...
2. Interação de gameplay na mesma região: tiro, projéteis, objetos e
   ...
   de juntas (`0x3DB0`, `0x6290`, `0x4840`) e o desbotamento da mira
   (`controlFadePlayer`) já estão portados.
